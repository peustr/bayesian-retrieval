...
from bret import BayesianBERTRetriever
...
from bret.trainers import BayesianDPRTrainer
...
def main():
    ...
    BayesianDPRTrainer.train(
        ...
        ckpt_file_name=get_checkpoint_file_name(args.output_dir, args.model_name, method="vi"),
    )
